    ...
    <q-list dense separator class="box">
      <q-item>
        <q-item-section align="center">
          <q-item-label> Receipt No. </q-item-label>
        </q-item-section>
        <q-item-section align="center">
          <q-item-label> Desc. / Company Name </q-item-label>
        </q-item-section>
        <q-item-section align="center">
          <q-item-label> Address </q-item-label>
        </q-item-section>
        <q-item-section align="center">
          <q-item-label> TIN No. </q-item-label>
        </q-item-section>
        <q-item-section align="center">
...
const expensesReports = computed(
  () => salesReportsStore.withReceiptExpensesReports
);
...
const removeExpenses = (index) => {
  salesReportsStore.removeWithReceiptExpenses(index);
};
</script>
