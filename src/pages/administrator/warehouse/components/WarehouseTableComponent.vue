      ...
      <q-markup-table flat class="premium-table">
        <thead>
          <tr>
            ...
            <th class="text-left" style="width: 20%"><q-skeleton type="text" width="50%" /></th>
            <th class="text-left" style="width: 20%"><q-skeleton type="text" width="50%" /></th>
        ...
        <tbody>
          <tr v-for="n in 5" :key="n">
            ...
            <td class="text-center"><q-skeleton type="text" width="40%" class="q-mx-auto" /></td>
            <td><q-skeleton type="rect" width="50px" height="20px" style="border-radius: 4px;" /></td>
            <td>
